...
struct Coord
{
    ...
    inline static unsigned short get90degreeDirPos(unsigned short pos, char dir);
    inline static unsigned short get270degreeDirPos(unsigned short pos, char dir);
};
...
inline unsigned short Coord::get90degreeDirPos(unsigned short pos, char dir)
{
    switch (dir)
    {
        case TOP:
...
inline unsigned short Coord::get270degreeDirPos(unsigned short pos, char dir)
{
    switch (dir)
    {
        case TOP:
