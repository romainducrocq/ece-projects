...
bool Graphic::_imageLoadSprites()
{
    ...
    this->pSprites[1] = imageLoad("images/mario/mur.bmp");
    this->pSprites[2] = imageLoad("images/mario/caisse.bmp");
    this->pSprites[3] = imageLoad("images/mario/caisse_ok.bmp");
    this->pSprites[4] = imageLoad("images/mario/objectif.bmp");
    ...
    this->pSprites[8] = imageLoad ("images/mario/box_on_deadlock.bmp");
    this->pSprites[9] = imageLoad ("images/mario/deadlock.bmp");
    this->pSprites[10] = imageLoad ("images/mario/wallpaper.bmp");
    this->pSprites[11] = imageLoad ("images/mario/click.bmp");
    this->pSprites[12] = imageLoad ("images/mario/retour.bmp");
    this->pSprites[13] = imageLoad ("images/mario/musicPlayPause.bmp");

    this->pSpritesPlayer[0] = imageLoad("images/mario/mario_haut.bmp");
    this->pSpritesPlayer[1] = imageLoad("images/mario/mario_bas.bmp");
    this->pSpritesPlayer[2] = imageLoad("images/mario/mario_gauche.bmp");
    this->pSpritesPlayer[3] = imageLoad("images/mario/mario_droite.bmp");
...
void Graphic::OnScreen()
{
    blit(pBuffer,screen,0,0,0,0,SCREEN_W,SCREEN_H);
}

bool Graphic::De4dMouse(int xBegin, int yBegin, int xEnd, int yEnd)
{
...
void Graphic::Texte(int police, std::string txt, int x, int y, int colorFont, int colorBackGround, bool centre)
{
    FONT *myfont;
    switch (police)
      {
      ...
      {
         case true:
            textout_centre_ex(pBuffer,myfont,txt.c_str(),x,y,colorFont,colorBackGround);
            break;
         case false:
            textout_ex(pBuffer,myfont,txt.c_str(),x,y,colorFont,colorBackGround);
            break;
      }
